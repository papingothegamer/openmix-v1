...
<style>
    ...
    .toast.info { border-left: 4px solid #eab308; }
    ...
    .info .toast-icon { color: #eab308; }

    .toast-content { flex: 1; font-size: 0.875rem; font-weight: 500; line-height: 1.4; color: #e5e5e5; }
